...
import { ShoppingBag, Menu, X, User, LogOut, ChevronDown, RotateCcw } from 'lucide-react';
    ...
    <nav className="navbar glass">
          ...
          {customer ? (
            <div style={{ position: 'relative' }} className="user-dropdown">
              ...
              <div className="dropdown-menu" style={{
                ...
                <Link to="/my-returns" style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', padding: '0.6rem', color: 'var(--text-main)', textDecoration: 'none', fontSize: '0.8rem', borderRadius: '6px' }} className="hover-bg">
      ...
      {isOpen && (
        <div style={{
          ...
          {customer && <Link to="/my-returns" onClick={() => setIsOpen(false)} style={{ padding: '0.75rem', textDecoration: 'none', color: 'var(--text-main)', fontWeight: 600, borderRadius: 'var(--radius-sm)' }}>My Returns</Link>}
        </div>
      )}
